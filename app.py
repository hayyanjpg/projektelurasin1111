...
import os  # Untuk membaca variabel environment
...
app.secret_key = os.environ.get('SECRET_KEY', 'supersecretkey')  # Gunakan environment variable untuk secret key jika ada
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5000))  # Gunakan PORT dari environment variable jika ada
